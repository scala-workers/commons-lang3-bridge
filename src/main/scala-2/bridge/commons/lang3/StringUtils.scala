...
object StringUtils {
  ...
  object opt {
    def apply(value: String): Option[String] = Option(value)

    implicit def str2opt(value: String): Option[String] = Option(value)

    implicit def chr2Opt(value: Char): Option[Char] = Option(value)

    implicit def chs2opt(value: CharSequence): Option[CharSequence] = Option(value)

    implicit class StringOpt(box: Option[String]) extends ops.StringOps(box.orNull) {
  ...
  object ops {
    implicit class StringOps(str: String) {
      ...
      def contains(seq: CharSequence): Boolean = Strings.contains(str, seq)

      def contains(searchChar: Char): Boolean = Strings.contains(str, searchChar)

      def containsAny(searchChars: Char*): Boolean = Strings.containsAny(str, searchChars: _*)
      ...
      def indexOfAny(searchChars: Char*): Int = Strings.indexOfAny(str, searchChars: _*)
      ...
      def indexOfAnyBut(searchChars: Char*): Int = Strings.indexOfAnyBut(str, searchChars: _*)
